var express        = require('express'),
    ...
    api2           = require('./backend/backEndTest');
...
app.get('/api/backEndTest', api2.backEndTest);
app.get('/api/backEndListColours', api2.backEndListColours);
...
app.listen(8080);
console.log('REST Magic happens on port 8080...');